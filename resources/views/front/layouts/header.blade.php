...
<head>
  ...
  @if($config->fovicon!=null)
    <link rel="shortcut icon" type="image/png" href="{{asset($config->fovicon)}}"/>
  @endif
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('contact')}}">İLETİŞİM</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  style="background-image: url('@yield('background',asset('front/img/home-bg.jpg'))')">
