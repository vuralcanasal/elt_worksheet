  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.dashboard')}}">
        ...
        <div class="sidebar-brand-text"> {{$config->title}} </div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse @if(Request::segment(2)=="articles") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('admin.articles.index')}}">Tüm İçerikler</a>
            <a class="collapse-item" href="{{route('admin.articles.create')}}">İçerik Oluştur</a>
          </div>
        </div>
      </li>
